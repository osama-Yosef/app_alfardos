            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      padding: EdgeInsets.all(8),
                      child: Icon(Icons.factory, color: Colors.white, size: 18.sp),
                    ),
                  ),
                ),
                SizedBox(width: 8.w),
                Expanded(
                  child: InkWell(
                    onTap: (){
                      Navigator.pushNamed(context, Routes.customerRequests);
                    },
                    child: Container(
                      decoration: BoxDecoration(
                        color: Colors.transparent,
                ...
                Expanded(
                  child: InkWell(
                    onTap: (){
                      Navigator.pushNamed(context, Routes.liveProductionFollowUp);
                    },
                    child: Container(
                      decoration: BoxDecoration(
                        color: Colors.transparent,
